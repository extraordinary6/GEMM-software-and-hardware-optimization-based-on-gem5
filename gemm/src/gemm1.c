// This file is a GEMM based on matrix partitioning optimization
// Author: hcf
...
void matmul_block(int A[SIZE][SIZE], int B[SIZE][SIZE], int C[SIZE][SIZE]) {
    int i, j, k, ii, jj, kk;
...
int main() {
    ...
    printf("GEMM based on matrix partitioning finished, took %f seconds!\n", time_taken);
    // print_matrix(C);
